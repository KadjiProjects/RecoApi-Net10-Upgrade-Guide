...
> .NET version. Use it whenever you have a project that depends on AutoMapper and you
...
coverage verifier, purpose-built to replace AutoMapper with explicit, compile-time-checked
code. Its complete, buildable source lives alongside this guide at
...
| [02-add-the-library.md](02-add-the-library.md) | Bringing ExplicitMapping into your project; the pre-C#11 fallback variant · GATE 1 |
