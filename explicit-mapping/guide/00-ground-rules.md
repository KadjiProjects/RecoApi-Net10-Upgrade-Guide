> **AutoMapper → ExplicitMapping generic migration guide — part 1 of 9.** Start at the
> [README](README.md) and execute files in order. Section (§) numbers are global across
> this guide — the README maps each § to its file.
