...
/// being declared unmapped-by-design. This is the exact pattern
/// RecoAPI's <c>MappingCoverageTests</c> runs for all 8 real entities (see the upgrade
/// guide's 06-verification.md and appendix-b-coverage-tests.md); the types here are demo
/// stand-ins so this repository has no dependency on RecoAPI's private domain code.
/// </summary>
[TestFixture]
